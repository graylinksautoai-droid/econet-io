...
const CommandCenter = ({ reports = [], user }) => {
  ...
  return (
    <div className={`min-h-screen text-white ${isDark ? 'bg-gray-900' : isLight ? 'bg-gray-100' : 'bg-green-900'} ${isFullscreen ? 'fixed inset-0 z-50' : ''}`}>
      {/* Command Header */}
              ...
              <div className="flex space-x-1 bg-gray-700 rounded-lg p-1">
                <button
                  ...
                  className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                    viewMode === 'map' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:text-white'
                  }`}
                >
                ...
                <button
                  ...
                  className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                    viewMode === 'analytics' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:text-white'
                  }`}
                >
                ...
                <button
                  ...
                  className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                    viewMode === 'tracking' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:text-white'
                  }`}
                >
                ...
                <button
                  ...
                  className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                    viewMode === 'routing' ? 'bg-gray-900 text-white' : 'text-gray-300 hover:text-white'
                  }`}
                >
      ...
      <div className="flex h-screen">
        ...
        <aside className="w-80 bg-gray-800 border-r border-gray-700 p-4 overflow-y-auto">
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center p-3 bg-gray-700 rounded-lg">
                ...
                <span className="text-lg font-bold text-yellow-500">{reports.length}</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-gray-700 rounded-lg">
                <span className="text-sm">Critical Situations</span>
                <span className="text-lg font-bold text-red-500">{pinnedSituations.length}</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-gray-700 rounded-lg">
                <span className="text-sm">Active Trackers</span>
                <span className="text-lg font-bold text-green-500">{trackingData.length}</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <button className="w-full px-3 py-2 bg-green-600 hover:bg-green-700 rounded-lg text-sm font-medium transition-colors">
                <FaDownload className="inline mr-2" />
                Export API Key
              </button>
              <button className="w-full px-3 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg text-sm font-medium transition-colors">
        ...
        <main className="flex-1 bg-gray-900">
          {viewMode === 'map' && (
            <div className="h-full relative" style={{ height: 'calc(100vh - 120px)' }}>
              <MapView 
